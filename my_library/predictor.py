# Example from https://github.com/allenai/allennlp-as-a-library-example/blob/master/my_library/predictors/paper_classifier_predictor.py
# TODO: Didn't get to implementation for this homework.
